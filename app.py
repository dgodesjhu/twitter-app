...
st.write("🔍 Debug: API Key Exists:", bool(aopenai.pi_key))  # Should print True if the key is found
st.write("🔍 Debug: API Key (first 5 chars):", openai.api_key[:5] if api_key else "Not Found")
